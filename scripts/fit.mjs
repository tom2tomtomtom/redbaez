...
// concurrent runs never collide on the same socket, and a leaked listener
// from a crashed run never blocks the next.
...
if (missingSelector) {
  console.log(`FAIL selector not found: ${missingSelector}`);
  process.exit(1);
}
